...
public class ShiroConfig {
    ...
    //登录url
    private static final String loginUrl = "/mall/toLogin";

    //没有权限的页面
    private static final String notloginUrl = "/mall/toNoAuthority";
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager,
                                                         ...
                                                         @Qualifier("LoginFiter") AdviceFilter ad ,
                                                         @Qualifier("RoleFilter") RolesAuthorizationFilter rolesFilter) {
        ...
        //定义没有权限的页面
        shiroFilterFactoryBean.setUnauthorizedUrl(notloginUrl);
   ...
   //角色拦截
    ...
    //session会话
    @Bean("SessionManager")
    public DefaultWebSessionManager defaultWebSessionManager(AbstractSessionDAO abstractSessionDAO,@Qualifier("MySessionListener") SessionListener sessionListener) {
